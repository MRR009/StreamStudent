...
public interface AddressRepository extends JpaRepository<Address, Integer> {
	...
	@Modifying
	@Transactional
	@Query(value = "UPDATE address SET college_fk = :clg_id WHERE address_id = :address_id ", nativeQuery = true)
	public void updateCollegeAddress(@Param("clg_id") int clgId, @Param("address_id") int addressId );
